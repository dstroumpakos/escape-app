import { EscapeRoom, UserProfile, TimeSlot } from './types';
...
export const timeSlots: TimeSlot[] = [
  { id: '1', time: '10:00 AM', available: true, price: 35 },
  { id: '2', time: '11:30 AM', available: true, price: 35 },
  { id: '3', time: '1:00 PM', available: false, price: 35 },
  { id: '4', time: '2:30 PM', available: true, price: 35 },
  { id: '5', time: '4:00 PM', available: true, price: 38 },
  { id: '6', time: '5:30 PM', available: true, price: 38 },
  { id: '7', time: '7:00 PM', available: true, price: 42 },
  { id: '8', time: '8:30 PM', available: false, price: 42 },
];
...
export const userProfile: UserProfile = {
  ...
  badges: [
    { id: '1', title: 'First Escape', icon: '🔓', earned: true, date: '2025-03-15' },
    { id: '2', title: 'Speed Demon', icon: '⚡', earned: true, date: '2025-05-22' },
    { id: '3', title: 'Horror Survivor', icon: '👻', earned: true, date: '2025-07-10' },
    { id: '4', title: 'Team Leader', icon: '👑', earned: true, date: '2025-09-01' },
    { id: '5', title: 'Puzzle Master', icon: '🧩', earned: true, date: '2025-11-18' },
    { id: '6', title: 'Night Owl', icon: '🦉', earned: false },
  ],
  wishlist: ['2', '5'],
};
